...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ((__VLS_ctx.cn(__VLS_ctx.badgeVariants(), props.class))) }, });
    var __VLS_0 = {};
    var __VLS_slots;
...
const __VLS_self = (await Promise.resolve().then(() => __importStar(require('vue')))).defineComponent({
    setup() {
        return {
            badgeVariants: _1.badgeVariants,
            cn: utils_1.cn,
        };
    },
    __typeProps: {},
