...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.main, __VLS_intrinsicElements.main)({ id: ("app"), });
    ...
    const __VLS_2 = __VLS_1({}, ...__VLS_functionalComponentArgsRest(__VLS_1));
    {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ name: ("fade"), mode: ("out-in"), }));
        const __VLS_8 = __VLS_7({ name: ("fade"), mode: ("out-in"), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
