...
function __VLS_template() {
  ...
  const __VLS_1 = __VLS_asFunctionalComponent(
    __VLS_0,
    new __VLS_0({ ...{ class: "h-[96px] w-[250px] rounded-xl" } })
  );
  const __VLS_2 = __VLS_1(
    { ...{ class: "h-[96px] w-[250px] rounded-xl" } },
  ...
  const __VLS_13 = __VLS_asFunctionalComponent(
    __VLS_12,
    new __VLS_12({ ...{ class: "h-4 w-[200px]" } })
  );
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.p
  )({ ...{ class: "w-[240px] font-mono text-xs" } });
  __VLS_elementAsFunction(
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.a
  )({ href: "https://www.facebook.com/lesPetitsClochards/", target: "_blank" });
